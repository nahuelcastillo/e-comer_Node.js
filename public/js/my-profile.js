...
function loadUserDetailsIntoForm() {
  ...
  document.getElementById("second-name").value = user.secondName
  document.getElementById("first-lastname").value = user.firstLastname
  document.getElementById("second-lastname").value = user.secondLastname
